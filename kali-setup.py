...
def get_arguments():
	...
	arguments.project_path = arguments.vm_dir + os.sep + arguments.vm_name
	return arguments
...
def generate_vagrantfile():
	...
	if not os.path.exists(vagrantfile_path):
		...
		data += '\t\t\tansible.playbook = "kali.yml"\n'
		data += "\t\tend\n"
...
def create_vm():
	...
	copyfile("kali.yml", arguments.project_path + os.sep + "kali.yml")
	...
	# Vagrant Provision
	os.chdir(arguments.project_path)
